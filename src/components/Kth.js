/*
  ...
  ```
*/
//주석을 뭘 어떻게 달아야할지 모르겠어서 다는 주석
const bucketName = "honbab-bucket";
const objectKey = "627686_899652_521.jpg";

const imgUrl = `https://${bucketName}.s3.amazonaws.com/${objectKey}`;
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            ...
            <a
              href="#"
              className="font-semibold leading-6 text-[#54AB75] hover:text-[#49965F]"
            >
              Start a Register
            </a>
          </p>
